...
$sql="SELECT *, DATE_FORMAT(capnhat,'%H:%i ngày %d-%m-%Y') as datetime FROM gws_lienhe WHERE id_lienhe=".$_GET["id_lienhe"];
...
<table width="100%" border="0" cellspacing="0" cellpadding="4">
  <tr>
    <td colspan="2"><font size="2"><b>Thông tin liên hệ</b></font></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
