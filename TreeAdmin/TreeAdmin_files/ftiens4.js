...
{ 
  ...
  this.nodeImg = 0;
  this.isLastNode = 0;
  this.pngnSrc = ICONPATH + "TreeAdmin_files/ftv2folderopen.gif";
  this.pngnSrcClosed = ICONPATH + "TreeAdmin_files/ftv2folderclosed.gif";
  ...
  this.pngnImageSrc = iconImageSrc
  this.getID = getID
...
{ 
  ...
  if (this.level>0) 
    if (this.isLastNode) //the last child in the children array 
      ...
      leftSide = leftSide + "<td valign=top background=" + ICONPATH + "TreeAdmin_files/ftv2vertline.gif>" + auxEv + "<img name='nodeIcon" + this.id + "' id='nodeIcon" + this.id + "' src='" + nodeName + "' width=16 height=22 border=0></a></td>"
  ...
  if (USEICONS)
  {
    ...
    docW = docW + "<img id='folderIcon" + this.id + "' name='folderIcon" + this.id + "' src='" + this.pngnImageSrc() + "' border=0></a>"
  }
  else
  {
	  if (this.prependHTML == "")
        docW = docW + "<img src=" + ICONPATH + "TreeAdmin_files/ftv2blank.gif height=2 width=2>"
  }
  if (WRAPTEXT)
  ...
  { 
    ...
    if (USEICONS)
      this.pngnImg = this.navObj.document.images["folderIcon"+this.id] 
  ...
  { 
    ...
    if (USEICONS)
      this.pngnImg = getElById("folderIcon"+this.id) 
...
{   
  ...
  //Change node
  if (USEICONS)
    folder.pngnImg.src = folder.pngnImageSrc()
...
function nodeImageSrc() {
  ...
  { 
    if (this.nChildren == 0)
      srcStr = ICONPATH + "TreeAdmin_files/ftv2lastnode.gif"
    else
      if (this.isOpen)
        srcStr = ICONPATH + "TreeAdmin_files/ftv2mlastnode.gif"  
      else
        srcStr = ICONPATH + "TreeAdmin_files/ftv2plastnode.gif"  
  } 
  else 
  { 
    if (this.nChildren == 0)
      srcStr = ICONPATH + "TreeAdmin_files/ftv2node.gif"
    else
      if (this.isOpen)
        srcStr = ICONPATH + "TreeAdmin_files/ftv2mnode.gif"
      else
        srcStr = ICONPATH + "TreeAdmin_files/ftv2pnode.gif"
  }   
  return srcStr;
}
...
function finalizeCreationOfItem(itemArray)
{
  ...
  itemArray.pngnImg = 0 //initialized in render() 
  itemArray.pngnSrc = ICONPATH + "TreeAdmin_files/ftv2doc.gif" 
...
{ 
  ...
  if (this.level>0) 
    ...
    { 
      leftSide = leftSide + "<td valign=top><img src='" + ICONPATH + "TreeAdmin_files/ftv2lastnode.gif' width=16 height=22></td>"
    } 
    else 
    { 
      leftSide = leftSide + "<td valign=top background=" + ICONPATH + "TreeAdmin_files/ftv2vertline.gif><img src='" + ICONPATH + "TreeAdmin_files/ftv2node.gif' width=16 height=22></td>"
    } 
  ...
  docW = docW + "<tr>" + leftSide + "<td valign=top>"
  if (USEICONS)
      docW = docW + "<a " + fullLink  + " id=\"itemIconLink"+this.id+"\">" + "<img id='itemIcon"+this.id+"' " + "src='"+this.pngnSrc+"' border=0>" + "</a>"
  else
	  if (this.prependHTML == "")
        docW = docW + "<img src=" + ICONPATH + "TreeAdmin_files/ftv2blank.gif height=2 width=3>"
  ...
  if (browserVersion == 2) { 
    ...
    if (USEICONS)
      this.pngnImg = this.navObj.document.images["itemIcon"+this.id] 
    doc.yPos=doc.yPos+this.navObj.clip.height 
  } else if (browserVersion != 0) { 
    this.navObj = getElById("item"+this.id)
    if (USEICONS)
      this.pngnImg = getElById("itemIcon"+this.id)
  } 
} 
...
function leftSideHTML(leftSideCoded) {
	...
	for (i=0; i<leftSideCoded.length; i++)
	{
		...
		{
			retStr = retStr + "<td valign=top background=" + ICONPATH + "TreeAdmin_files/ftv2vertline.gif><img src='" + ICONPATH + "TreeAdmin_files/ftv2vertline.gif' width=16 height=22></td>"
		}
		if (leftSideCoded.charAt(i) == "0")
		{
			retStr = retStr + "<td valign=top><img src='" + ICONPATH + "TreeAdmin_files/ftv2blank.gif' width=16 height=22></td>"
		}
	}
	return retStr
}
...
function preLoadIcons() {
	var auxImg
	auxImg = new Image();
	auxImg.src = ICONPATH + "TreeAdmin_files/ftv2vertline.gif";
	auxImg.src = ICONPATH + "TreeAdmin_files/ftv2mlastnode.gif";
	auxImg.src = ICONPATH + "TreeAdmin_files/ftv2mnode.gif";
	auxImg.src = ICONPATH + "TreeAdmin_files/ftv2plastnode.gif";
	auxImg.src = ICONPATH + "TreeAdmin_files/ftv2pnode.gif";
	auxImg.src = ICONPATH + "TreeAdmin_files/ftv2blank.gif";
	auxImg.src = ICONPATH + "TreeAdmin_files/ftv2lastnode.gif";
	auxImg.src = ICONPATH + "TreeAdmin_files/ftv2node.gif";
	auxImg.src = ICONPATH + "TreeAdmin_files/ftv2folderclosed.gif";
	auxImg.src = ICONPATH + "TreeAdmin_files/ftv2folderopen.gif";
	auxImg.src = ICONPATH + "TreeAdmin_files/ftv2doc.gif";
}
