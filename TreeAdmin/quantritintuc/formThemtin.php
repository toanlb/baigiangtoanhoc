...
//	  $gt=str_replace("\"","&quot;",$_POST["$sForm"]);
  ...
  {
	mysql_query(InputData("gws_tinbai",$id_parent));
	//echo InputData("gws_tinbai",$id_parent);exit;
...
<table width="99%" border="0" align="center" cellpadding="4" cellspacing="1" class="mainTb">
  ...
  <!--Tieu de tin-->
  <tr>
    <td colspan="2"><font size=2><b>Quản lý Tin tức - Thêm nội dung tin</b></font></td>
  </tr>
...
<!--Trich dan tin-->
  <tr>
    ...
    <td><textarea name="trichdan" class="TexBox" cols="50" rows="7" wrap="virtual"></textarea></td>
  </tr>
  <tr style="display:none;">
    <td ><?php echo $arr_tin["them_trichdan_eng"];?></td>
    <td><textarea name="trichdan_eng" class="TexBox" cols="50" rows="7" wrap="virtual"></textarea></td>
  </tr>
<!--Het-->
<!--Noi dung tin-->
  <tr>
