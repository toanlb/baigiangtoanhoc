...
function doKiemduyet(ck)
{
  ...
  ifKiemduyet.location="quantrivideo/kiemduyet.php?id="+ck.name+"&trangthai="+tt;
}
</script>
<body>
...
<table align="center" width="99%" border="0" cellspacing="0" cellpadding="4">
  ...
  <tr class="gridRow">
	...
	<a href="javascript:window.location='formSua.php?id_parent=<?php echo $id_parent;?>&kieunhap=form_suavideo&id_logo=<?php echo $row["id_logo"];?>';"><?php echo $arr_chung["sua"] ?></a>
