<?php
  ...
  {
	mysql_query(InputData("gws_khachhang",$id_parent));
	//echo InputData("gws_khachhang",$id_parent);exit;
...
<table align="center" width="99%" border="0" cellspacing="1" cellpadding="4" class="mainTb">
  <tr>
    <td colspan="2"><font size=2><b>Module Quản lý Khách hàng- Thêm khách hàng </b></font></td>
  </tr>
  <form action="?status=submit&id_parent=<?php echo $id_parent;?>&kieunhap=<?php echo $kieunhap;?>" method="post" name="frmAddnew">  
  <tr>
    <td>Tên khách hàng </td>
    <td ><input name="tencongty" type="text" id="tencongty" size="40"></td>
  </tr>
  <tr>
    <td>Tên giao dịch</td>
    <td ><input name="tengiaodich" type="text" id="tengiaodich" size="40"></td>
  </tr>
  <tr>
    <td>Địa chỉ </td>
  ...
  <tr>
    <td width="20%">Logo</td>
    <td ><input name="logo" type="text" id="filedownload" size="40"><input name="btnImg" type="button" id="btnImg" onClick="BrowseServer('Image',frmAddnew.logo);" value="Logo"></td>
  </tr>
  <tr>
    <td>Ngành nghề</td>
    <td>
