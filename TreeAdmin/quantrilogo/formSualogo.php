<?php
  ...
  {   
	...
	echo "<script language='javascript'>window.location='danhsach.php?id_parent=$id_parent&kieunhap=ds_logo';</script>";
  }
?>
<html>
<head>
...
<table align="center" width="99%" border="0" cellspacing="1" cellpadding="4">
  ...
  ?>
  <tr>
    <td width="20%">File quảng cáo</td>
    <td ><p>
      <input name="logo" type="text" id="logo" value="<?php echo $rowanh["logo"];?>" size="40">
      &nbsp;
      <input name="button" type="button" class="smallButton" value="Chọn file" onClick="BrowseServer('Image',frmEdit.logo);">
    </p>      </td>
  </tr>  
  <tr>
    <td >Kích thước file </td>
    <td ><input name="rong" type="text" id="rong" value="<?php echo $rowanh["rong"];?>" size="5" maxlength="10"> 
      px 
        <input name="cao" type="text" id="cao" value="<?php echo $rowanh["cao"];?>" size="5" maxlength="10"> 
      px (Chiều rộng x Chiều cao) </td>
  </tr>
  <tr>
    <td >Tiêu đề</td>
    <td >
	
	 <textarea name="tieude" id="tieude"  class="TexBox" cols="50" rows="7" wrap="virtual"><?php echo $rowanh["tieude"];?></textarea>
	</td>
  </tr>
  <tr>
    <td >Liên kết tới</td>
  ...
  <tr>
    <td>Định dạng </td>
    <td>Flash <input name="type" type="radio" value="1" <?php if($rowanh["type"]==1) echo "checked";?>>
	Ảnh <input name="type" type="radio" value="0" <?php if($rowanh["type"]==0) echo "checked";?>></td>
  </tr>
  <tr>
    <td>Hiển thị </td>
