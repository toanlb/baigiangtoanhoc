...
<table align="center" width="99%" border="0" cellspacing="1" cellpadding="4" class="mainTb">
  <tr>
    <td colspan="2"><font size=2><b>Module Quảng cáo - Thêm quảng cáo</b></font></td>
  </tr>
  ...
  <tr>
    ...
    <td ><input name="logo" type="text" id="logo" size="40"><input type="button" value="Chọn file" onClick="BrowseServer('Image',frmAddnew.logo);">
	</td>
  </tr>  
  <tr>
    <td >Kích thước file </td>
    <td ><input name="rong" type="text" id="rong" size="5" maxlength="10"> 
      px 
        <input name="cao" type="text" id="cao" size="5" maxlength="10"> 
  ...
  <tr>
    <td >Tiêu đề</td>
	 ...
	 <td><textarea name="tieude" class="TexBox" cols="50" rows="7" wrap="virtual" id="tieude"></textarea></td>
  </tr>
  ...
  <tr>
	...
	Ảnh 
	<input type="radio" name="type" value="0" checked></td>
  </tr>
  <tr>
    <td>Hiển thị </td>
    <td>
