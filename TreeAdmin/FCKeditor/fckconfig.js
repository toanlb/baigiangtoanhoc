...
FCKConfig.ToolbarSets["Standard"] = [
	...
	['Undo','Redo','RemoveFormat','PasteText','PasteWord'],
	['OrderedList','UnorderedList','Outdent','Indent'],['Link','Unlink'],
	['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull'],
	['FontName','FontSize'],
	['Image','Flash','Table','Rule','SpecialChar','Smiley'],['TextColor','BGColor']
] ;

FCKConfig.ToolbarSets["Basic"] = [
	['Source','Bold','Italic','-','OrderedList','UnorderedList','-','Link','Unlink','-','Table','TextColor']
] ;
...
FCKConfig.LinkUploadURL = FCKConfig.BasePath + 'filemanager/upload/asp/upload.php' ;
