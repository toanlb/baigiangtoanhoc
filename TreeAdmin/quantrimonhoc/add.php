<?php
  ...
  {
	mysql_query(InputData("gws_monhoc",$id_parent));
...
<table align="center" width="99%" border="0" cellspacing="1" cellpadding="4" class="mainTb">
  <tr>
    <td colspan="2"><font size=2><b>Quản lý Môn học- Thêm Môn học </b></font></td>
  </tr>
  <form action="?status=submit&id_parent=<?php echo $id_parent;?>&kieunhap=<?php echo $kieunhap;?>" method="post" name="frmAddnew">  
  <tr>
    <td>Tên môn học </td>
    <td ><input name="tenmh" type="text" id="tenmh" size="40"></td>
  </tr>
  <tr>
