...
<?php
  if(isset($_GET["status"]))
  {
    ...
    if($count==1)
    {
      $sql="update gws_admin set username='$newusername',password='$newpassword',capnhat=Now() where username='$username' and password='$password'";	  
	  $result=mysql_query($sql,$link);?>	  
...
<table width="99%" border="0" align="center" cellpadding="4" cellspacing="1">
  <tr>
    <td colspan="2"><font size=2><b>Module Hệ thống - Sửa thông tin người dùng</b></font></td>
  </tr>
  <form name="frm" method="post" action="doitaikhoan.php?status=submit">
	<tr>
	  <td width="20%"><?php echo $arr_tkhoan["tk_cu"] ?></td>
	  <td><input name="username" type="text" class="TextBox" value="<?php echo $s_user;?>" size="40" maxlength="40"></td>
	</tr>
	<tr> 
	  <td><?php echo $arr_tkhoan["tk_mk_cu"] ?></td>
	  <td><input name="password" type="password" class="TextBox" id="password" size="40" maxlength="40"></td>
	</tr>
	<tr> 
