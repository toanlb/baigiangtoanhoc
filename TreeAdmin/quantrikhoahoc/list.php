...
function doKhoahocvip(ck)
{
  if(ck.checked) tt=1;else tt=0;
  ifKiemduyet.location="quantrikhoahoc/khvip.php?id="+ck.name+"&trangthai="+tt;
}
...
<table align="center" width="99%" border="0" cellspacing="0" cellpadding="4">
  ...
  <tr>
    ...
    <td width="30%" class="gridTitle">&nbsp;&nbsp;Tên khóa học </td>
    <td width="15%" align="center" class="gridTitle">Ảnh  </td>
	<td width="17%" align="center" class="gridTitle">KH chuyên đề </td>
	 <td width="17%" align="center" class="gridTitle">KH VIP </td>
	  <td width="8%" align="center" class="gridTitle">Sắp khai giảng </td>
    <td width="8%" align="center" class="gridTitle">Hiển thị </td>
    <td width="10%" align="center" class="gridTitle">Vị trí </td>
  ...
  <tr class="gridRow">
	...
	<td class="gridRow" align="center"><input type="checkbox" name="<?php echo $row["id_kh"];?>" <?php if($row["khmoi2"]==1) echo "checked";?> onClick="doKhoahocvip(this)"></td>
	...
	<td class="gridRow" width="7%" align="center">
