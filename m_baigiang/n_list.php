...
?>
          ...
          <div class="mod-l">
            <div class="mod-l-in">
              ...
              <h3><a href="#"><? echo $row["tieude$noi"]?> </a></h3>
...
//]]>
              ...
              <div class="details">
                <a href="./?page=bai-giang-truc-tuyen&code=<?php echo get_key($row["id_parent"]);?>&id=<?php echo $row["id_tin"]?>" class="hold-img"><img src="<? echo $row["anhtrichdan"]?>" width="245" height="175" alt="img" /></a>
                <div> <a href="./?page=bai-giang-truc-tuyen&code=<?php echo get_key($row["id_parent"]);?>&id=<?php echo $row["id_tin"]?>"> <? echo $row["trichdan$noi"]?> </a></div>
          <!--end .box-title-->
	
              <a href="./?page=bai-giang-truc-tuyen&code=<?php echo get_key($row["id_parent"]);?>&id=<?php echo $row["id_tin"]?>" class="read-more">Chi tiết</a> </div>
            </div>
          </div>
