		 ...
		 <ul>
	<?php
	$sql="select id_tin,capnhat,tieude$noi, DATE_FORMAT(capnhat,'%d-%m') as dt,trichdan$noi from gws_tinbai where trim(tieude$noi)<>'' and id_parent=".get_id("gioi-thieu")." and kiemduyet=1 and tinnong=1 order by capnhat desc limit 4";
...
?>
      ...
      <li>
          ...
          <a href="./?page=tu-van&code=<?php echo get_key($row["id_parent"]);?>&id=<?php echo $row["id_tin"]?>"> <? echo $cOutpu?> </a>
		  </li>
