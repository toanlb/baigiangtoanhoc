...
$sql="select * from gws_logo where id_parent=".get_id("header112")." and kiemduyet=1 order by capnhat asc";
$rs=mysql_query($sql);
...
while($row=mysql_fetch_array($rs)){
	if ($row["type"]==1)
		...
		else echo "<div class=\"glidecontent\"><a href=\"".$row['lienket']."\"><img src=\"".$row['logo']."\" border=\"0\" width=\"940px\" \" height=\"".$row["cao"]."\" title=\"".$row['tieude']."\"></a></div>";
}}?>
