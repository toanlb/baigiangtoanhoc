 <?php
  $sql="select capnhat,luotxem,username,DATE_FORMAT(capnhat,'%d-%m-%Y') as hs, tieude$noi,anhtrichdan, noidung$noi,trichdan$noi from gws_tinbai where trim(tieude$noi)<>'' and id_tin=$id";
