	...
	<?php
	  ...
	  $sql="select id_tin,DATE_FORMAT(capnhat,'Cập nhật lúc %H:%i ngày %d/%m/%Y') as hs,DATE_FORMAT(capnhat,'(%d/%m/%Y)') as dt, anhtrichdan,tieude$noi,trichdan$noi from gws_tinbai where trim(tieude$noi)<>'' and id_parent=".get_id($_GET["code"])." and kiemduyet=1";
	...
	?>
	 ...
	 <div class="news">
                    ...
                    <div class="title"><a href="<?php echo $href;?>"><?php echo $row["tieude$noi"];?></a></div>
